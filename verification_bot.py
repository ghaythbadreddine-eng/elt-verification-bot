...
WAITING_FOR_HELP_VC_ID = None   # TODO: paste the "Waiting for Help" voice channel ID here
HELP_ALERT_CHANNEL_ID = VERIFICATION_CHANNEL_ID  # channel where help alerts get posted - change this if you want it separate from VERIFICATION_CHANNEL_ID
...
class HelpRequestView(discord.ui.View):
    """Single 'Mark as Resolved' button for help alerts. Doesn't touch any roles."""
...
async def on_voice_state_update(member: discord.Member, before: discord.VoiceState, after: discord.VoiceState):
    ...
    elif WAITING_FOR_HELP_VC_ID is not None and joined_id == WAITING_FOR_HELP_VC_ID and came_from_id != WAITING_FOR_HELP_VC_ID:
